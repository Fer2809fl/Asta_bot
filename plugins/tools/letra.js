...
const styleNames = {
    1:'Soft Cursive', 2:'Fancy Serif', 3:'Bold Sans', 4:'Small Caps',
    5:'Italic Serif', 6:'Bold Serif', 7:'Calligraphic', 8:'Bold Mono Sans',
    9:'Monospace', 10:'Sans Italic', 11:'Sans Regular', 12:'Fullwidth',
    13:'Superscript', 14:'Bold Gothic', 15:'Circled Upper', 16:'Boxed Upper',
    17:'Cursive Script', 18:'Circled Lower', 19:'Blocky Mono', 20:'Fraktur', 21:'Brackets'
}
    ...
    switch (command) {
        case 'letra': {
            if (!text) return conn.sendMessage(m.chat, {
                text: `> . ﹡ ﹟ 🔤 ׄ ⬭ *¡ᴄᴏɴᴠᴇʀᴛɪᴅᴏʀ ᴅᴇ ʟᴇᴛʀᴀꜱ!*

*ㅤꨶ〆⁾ ㅤׄㅤ⸼ㅤׄ *͜🔤* ㅤ֢ㅤ⸱ㅤᯭִ*

ׅㅤ𓏸𓈒ㅤׄ *ᴜsᴏ* :: \`#letra (texto)\`
ׅㅤ𓏸𓈒ㅤׄ *ᴇꜱᴛɪʟᴏ ᴀᴄᴛᴜᴀʟ* :: ${styleNames[global.currentFontStyle] || global.currentFontStyle}
ׅㅤ𓏸𓈒ㅤׄ *ᴄᴀᴍʙɪᴀʀ ᴇꜱᴛɪʟᴏ* :: \`#style (1-21)\`
...
> . ﹡ ﹟ ⚡ ׄ ⬭ *ᴀsᴛᴀ-ʙᴏᴛ-ᴍᴅ*`.trim(),
            ...
            await conn.sendMessage(m.chat, {
                text: `> . ﹡ ﹟ 🔤 ׄ ⬭ *¡ᴛᴇxᴛᴏ ᴄᴏɴᴠᴇʀᴛɪᴅᴏ!*

*ㅤꨶ〆⁾ ㅤׄㅤ⸼ㅤׄ *͜🔤* ㅤ֢ㅤ⸱ㅤᯭִ*

ׅㅤ𓏸𓈒ㅤׄ *ᴏʀɪɢɪɴᴀʟ* :: ${text}
ׅㅤ𓏸𓈒ㅤׄ *ᴄᴏɴᴠᴇʀᴛɪᴅᴏ* :: ${result}
ׅㅤ𓏸𓈒ㅤׄ *ᴇꜱᴛɪʟᴏ* :: ${styleNames[global.currentFontStyle] || global.currentFontStyle}

> . ﹡ ﹟ ⚡ ׄ ⬭ *ᴀsᴛᴀ-ʙᴏᴛ-ᴍᴅ*`.trim(),
                contextInfo: { ...rcanal }
            }, { quoted: m })
            setTimeout(async () => await m.react('✔️'), 800)
            break
        }
        case 'style': {
            if (!text) {
                let lista = `> . ﹡ ﹟ 🔤 ׄ ⬭ *¡ᴇꜱᴛɪʟᴏꜱ ᴅɪꜱᴘᴏɴɪʙʟᴇꜱ!*\n\n`
                lista += `*ㅤꨶ〆⁾ ㅤׄㅤ⸼ㅤׄ *͜🔤* ㅤ֢ㅤ⸱ㅤᯭִ*\n\n`
                for (let i = 1; i <= 21; i++) {
                    lista += `ׅㅤ𓏸𓈒ㅤׄ *#${i}* :: ${styleNames[i]}\n`
                }
                lista += `\n> . ﹡ ﹟ ⚡ ׄ ⬭ *ᴀsᴛᴀ-ʙᴏᴛ-ᴍᴅ*`
            ...
            if (!yStr[num]) return conn.sendMessage(m.chat, {
                text: `> . ﹡ ﹟ 🔤 ׄ ⬭ *¡ᴇʀʀᴏʀ!*

*ㅤꨶ〆⁾ ㅤׄㅤ⸼ㅤׄ *͜❌* ㅤ֢ㅤ⸱ㅤᯭִ*

ׅㅤ𓏸𓈒ㅤׄ *ᴇʀʀᴏʀ* :: ᴇꜱᴛɪʟᴏ ${num} ɴᴏ ᴅɪꜱᴘᴏɴɪʙʟᴇ
ׅㅤ𓏸𓈒ㅤׄ *ʀᴀɴɢᴏ* :: 1 ᴀʟ ${Object.keys(yStr).length}
...
> . ﹡ ﹟ ⚡ ׄ ⬭ *ᴀsᴛᴀ-ʙᴏᴛ-ᴍᴅ*`.trim(),
            ...
            conn.sendMessage(m.chat, {
                text: `> . ﹡ ﹟ 🔤 ׄ ⬭ *¡ᴇꜱᴛɪʟᴏ ᴄᴀᴍʙɪᴀᴅᴏ!*

*ㅤꨶ〆⁾ ㅤׄㅤ⸼ㅤׄ *͜🔤* ㅤ֢ㅤ⸱ㅤᯭִ*

ׅㅤ𓏸𓈒ㅤׄ *ɴᴜᴇᴠᴏ ᴇꜱᴛɪʟᴏ* :: ${styleNames[num] || num}
ׅㅤ𓏸𓈒ㅤׄ *ᴇᴊᴇᴍᴘʟᴏ* :: ${example}
